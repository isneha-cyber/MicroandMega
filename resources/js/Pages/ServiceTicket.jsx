...
export default function ServiceTicket() {
  ...
  // Base URL for canonical and JSON-LD
  const baseUrl = typeof window !== 'undefined' ? window.location.origin : 'https://microandmega.com'
  const currentUrl = typeof window !== 'undefined' ? window.location.href : `${baseUrl}/service-ticket`

  // JSON-LD Structured Data for Service Ticket Page
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    '@id': currentUrl,
    'url': currentUrl,
    'name': 'Submit a Service Ticket | Micro & Mega',
    'description': 'Submit a service ticket for technical support, AMC partnership, product supply inquiries, or new registration. Micro & Mega provides advanced security systems and industrial products.',
    'isPartOf': {
      '@type': 'WebSite',
      'name': 'Micro & Mega',
      'url': baseUrl
    ...
    'mainEntity': {
      '@type': 'ContactPage',
      'name': 'Service Ticket Request Form',
      'description': 'Fill out this form to request technical support, AMC partnership, product supply, or new registration services.',
      'potentialAction': {
        '@type': 'CommunicateAction',
        'name': 'Submit Ticket',
        'description': 'Submit your service request through this form',
        'target': `${baseUrl}/service-tickets`
      }
    }
  }
  ...
  if (submitted) {
    return (
      <>
        <Head>
          <title>Ticket Submitted Successfully | Micro & Mega</title>
          <meta name="robots" content="noindex, follow" />
          <meta name="description" content="Your service ticket has been submitted successfully. Our team will contact you shortly." />
        </Head>
        <div
          className="min-h-screen flex items-center justify-center px-4"
          style={{ fontFamily: 'Barlow, sans-serif', background: 'linear-gradient(135deg,#fdf5f5 0%,#fff 60%)' }}
        >
          <div className="bg-white rounded-3xl shadow-2xl p-10 max-w-md w-full text-center border border-gray-100 flex flex-col items-center gap-4">
            ...
            <h1 className="text-2xl font-extrabold text-gray-900">Ticket Submitted!</h1>
            <p className="text-gray-500 text-sm leading-relaxed">
              Your service request has been received. Our team will get back to you shortly.
            </p>
            <div className="bg-red-50 border border-[#bb1403]/20 rounded-2xl px-6 py-4 w-full">
  ...
  return (
    <>
      <Head>
        <title>Submit Service Ticket | Micro & Mega - Technical Support & AMC</title>
        <meta name="description" content="Submit a service ticket for technical support, AMC partnership, product supply inquiries, or new registration. Get professional assistance from Micro & Mega's expert team." />
        <meta name="keywords" content="service ticket, technical support, AMC partnership, product supply, new registration, Micro & Mega, security systems support, industrial products service" />
        <meta name="author" content="Micro & Mega" />
        <meta name="robots" content="index, follow" />
        <meta name="language" content="English" />
        <meta name="revisit-after" content="7 days" />
        
        {/* Open Graph / Social Media Meta Tags */}
        <meta property="og:title" content="Submit Service Ticket | Micro & Mega" />
        <meta property="og:description" content="Submit a service ticket for technical support, AMC partnership, product supply inquiries, or new registration." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={currentUrl} />
        <meta property="og:image" content={`${baseUrl}/images/og-image.jpg`} />
        <meta property="og:site_name" content="Micro & Mega" />
        <meta property="og:locale" content="en_US" />
        
        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Submit Service Ticket | Micro & Mega" />
        <meta name="twitter:description" content="Submit a service ticket for technical support, AMC partnership, product supply inquiries, or new registration." />
      ...
      <div className="relative flex min-h-[420px] items-center justify-center bg-[url('/images/about-bg.jpg')] bg-cover bg-center bg-no-repeat px-6 py-12 sm:min-h-[420px] sm:py-20 lg:min-h-[550px] lg:bg-fixed">
        <div className="absolute inset-0 bg-gray-900/70 pointer-events-none" />
        <div className="relative z-20 flex flex-col items-center text-center">
          <h1 className="text-4xl font-extrabold uppercase text-white sm:text-5xl lg:text-6xl">Service Ticket</h1>
          <nav className="mt-2 text-sm font-semibold text-white sm:text-base lg:text-xl" aria-label="Breadcrumb">
            <Link href="/" className="hover:text-red-500 transition-colors duration-300">Home</Link>
            <span className="mx-2">/</span>
            <span aria-current="page">Service Ticket</span>
          </nav>
        </div>
      </div>
      ...
      {/* Page header */}
      <div className="max-w-7xl mx-auto mb-8 text-center pt-12 sm:px-0 px-4">
        <h2 className="text-2xl sm:text-5xl font-bold text-gray-900 leading-relaxed mb-2">
          Submit a Service Ticket
        </h2>
        <p className="text-gray-500 text-sm sm:text-md">
          Fill in the details below and our team will respond as quickly as possible.
      ...
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="max-w-2xl mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden mb-12"
        aria-label="Service Ticket Request Form"
      >
        <div className="h-1.5 bg-gradient-to-r from-[#bb1403] to-[#e84a35]" />
        ...
        <div className="p-6 sm:p-8 flex flex-col gap-6">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            <Field label="Requester Name" required error={errors.requesterName?.message}>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2" aria-hidden="true"><UserIcon /></span>
                <input
                  {...register('requesterName', { required: 'Name is required' })}
                  placeholder="John Doe"
                  className={`${inputCls(errors.requesterName)} pl-9`}
            ...
            <Field label="Email Address" required error={errors.email?.message}>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2" aria-hidden="true"><MailIcon /></span>
                <input
                  {...register('email', {
                    required: 'Email is required',
                    pattern: { value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/, message: 'Invalid email' },
          ...
          {/* Section 2 */}
          <SectionHeading number="02" title="Request Support For" />
          <div className="flex flex-col gap-3" role="group" aria-labelledby="support-for-label">
            <span id="support-for-label" className="sr-only">Select the type of support you need</span>
            {SUPPORT_OPTIONS.map((opt) => {
              const checked = supportFor.includes(opt.value)
              return (
                <button
                ...
                >
                  <span className={`w-5 h-5 rounded-md border-2 flex items-center justify-center flex-shrink-0 transition-colors
                    ${checked ? 'bg-[#bb1403] border-[#bb1403]' : 'border-gray-300'}`} aria-hidden="true">
                    {checked && (
                      <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                      </svg>
            ...
            {supportFor.length === 0 && (
              <p className="text-xs text-[#bb1403] font-medium flex items-center gap-1" role="alert">
                <span className="inline-block w-1 h-1 rounded-full bg-[#bb1403]" />
                Please select at least one option
              </p>
            )}
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            ...
            <Field label="Category / Department" required error={errors.categoryDepartment?.message}>
              <div className="relative">
                <select {...register('categoryDepartment', { required: 'Select a category' })}
                  className={`${inputCls(errors.categoryDepartment)} appearance-none pr-9`} defaultValue=""
                  aria-label="Category or Department">
                  <option value="" disabled>Select…</option>
                  {['Billing', 'Tech Support', 'Account', 'HR'].map((v) => <option key={v} value={v}>{v}</option>)}
                </select>
                <ChevronIcon />
          ...
          <Field label="Subject Line" required error={errors.subjectLine?.message}>
            <input
              ...
              aria-invalid={errors.subjectLine ? 'true' : 'false'}
            />
          </Field>
          ...
          <Field label="Detailed Description" required error={errors.detailedDescription?.message}>
            <textarea
              ...
              aria-invalid={errors.detailedDescription ? 'true' : 'false'}
            />
          </Field>
          ...
          <div>
            ...
            >
              <span className="w-10 h-10 rounded-full bg-gray-100 group-hover:bg-red-50 flex items-center justify-center transition-colors text-gray-400 group-hover:text-[#bb1403]" aria-hidden="true">
                <PaperclipIcon />
              </span>
              <p className="text-sm font-semibold text-gray-600 group-hover:text-[#bb1403] transition-colors">Click to attach files</p>
              <p className="text-xs text-gray-400">Supports .jpg, .png, .pdf — max 2 MB</p>
            </div>
            <input ref={fileInputRef} type="file" accept=".jpg,.jpeg,.png,.pdf" onChange={handleFileChange} className="hidden" aria-label="File attachment" />
            {file && (
              <ul className="mt-3 flex flex-col gap-2">
                <li className="flex items-center gap-2.5 bg-gray-50 rounded-xl px-3.5 py-2.5 border border-gray-100">
                  <span className="text-[#bb1403]" aria-hidden="true"><PaperclipIcon /></span>
                  <span className="text-sm text-gray-700 flex-1 truncate font-medium">{file.name}</span>
                  <span className="text-xs text-gray-400">{(file.size / 1024).toFixed(1)} KB</span>
                  <button type="button" onClick={removeFile}
                    className="w-5 h-5 rounded-full bg-gray-200 hover:bg-red-100 hover:text-[#bb1403] flex items-center justify-center transition-colors cursor-pointer"
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              disabled={isLoading || supportFor.length === 0}
              className="flex items-center justify-center gap-2 px-8 py-3 bg-[#bb1403] hover:bg-[#9e1102] disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold rounded-full transition-all text-sm shadow-md shadow-[#bb1403]/20 hover:shadow-lg hover:shadow-[#bb1403]/30 hover:-translate-y-0.5 active:translate-y-0 min-w-[160px]"
              aria-label="Submit Service Ticket"
            >
              {isLoading ? (
                <>
