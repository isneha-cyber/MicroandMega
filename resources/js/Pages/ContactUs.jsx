...
function InstagramIcon() {
  return (
    <svg xmlns="https://www.instagram.com/microandmega/" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
...
function FacebookIcon() {
  return (
    <svg xmlns="https://www.facebook.com/micronmega" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
...
function TwitterXIcon() {
  return (
    <svg xmlns="https://x.com/micronmega" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
